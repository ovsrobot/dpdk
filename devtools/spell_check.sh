...
all_check='false' # optional flag to check all documentation instead of changes detected by git
...
while test $# -gt 0; do
	...
	-h | --help)
		...
		echo "-a, --all-doc             Specify if all documentation should be checked."
		...
		echo "-r                        Specify a different regex pattern file."
		echo "-v                        Specify verbose logging."
		exit 0
		;;
	-a | --all-doc)
		shift
