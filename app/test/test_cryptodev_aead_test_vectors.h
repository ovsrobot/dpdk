...
static uint8_t sm4_gcm_aad_test_3[MAX_AAD_LENGTH] = {
		0x36, 0x94, 0xf6, 0x7b, 0x8a, 0x58, 0x4d, 0xed
};

static uint8_t sm4_gcm_aad_test_4[MAX_AAD_LENGTH] = {
		0xd5, 0x66, 0x06, 0x8f, 0xbc, 0x11, 0xb8
};

static uint8_t sm4_gcm_aad_test_6[MAX_AAD_LENGTH] = {
		0x1b, 0xcd
};

static uint8_t sm4_gcm_aad_test_7[MAX_AAD_LENGTH] = {
		0x6c, 0xac, 0xc4
};

static uint8_t sm4_gcm_aad_test_8[MAX_AAD_LENGTH] = {
		0x76, 0xb3, 0xad, 0x45, 0x78
};

static uint8_t sm4_gcm_aad_test_9[MAX_AAD_LENGTH] = {
		0x29
};

static uint8_t sm4_gcm_aad_test_11[MAX_AAD_LENGTH] = {
		0xfe, 0xed, 0xfa, 0xce, 0xde, 0xad, 0xbe, 0xef,
		0xfe, 0xed, 0xfa, 0xce, 0xde, 0xad, 0xbe, 0xef,
		0xab, 0xad, 0xda, 0xd2
};

static uint8_t sm4_gcm_aad_test_14[MAX_AAD_LENGTH] = {
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00
};

static uint8_t sm4_gcm_aad_test_15[MAX_AAD_LENGTH] = {
