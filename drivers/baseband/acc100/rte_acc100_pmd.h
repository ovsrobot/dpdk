...
struct __attribute__((__packed__)) acc100_fcw_td {
	uint8_t fcw_ver:4,
		num_maps:4; /* Unused */
...
struct __attribute__((__packed__)) acc100_fcw_ld {
...
struct __attribute__((__packed__)) acc100_fcw_te {
	uint16_t k_neg;
	uint16_t k_pos;
	uint8_t c_neg;
	uint8_t c;
...
struct __attribute__((__packed__)) acc100_fcw_le {
	uint32_t FCWversion:4,
		qm:4,
		nfiller:11,
		BG:1,
...
struct __attribute__((__packed__)) acc100_dma_req_desc {
	union {
		struct{
			uint32_t type:4,
				rsrvd0:26,
