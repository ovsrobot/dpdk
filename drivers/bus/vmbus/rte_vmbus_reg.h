...
__rte_packed_begin struct vmbus_message {
...
__rte_packed_begin struct vmbus_mon_trig {
 ...
 * Hyper-V Monitor Notification Facility
 */
__rte_packed_begin struct hyperv_mon_param {
	uint32_t	connid;
	uint16_t	evtflag_ofs;
	uint16_t	rsvd;
} __rte_packed_end;

__rte_packed_begin struct vmbus_mon_page {
	uint32_t	state;
	uint32_t	rsvd1;
...
__rte_packed_begin struct vmbus_bufring {
 ...
 * GPA stuffs.
 */
__rte_packed_begin struct vmbus_gpa_range {
	uint32_t       len;
	uint32_t       ofs;
	uint64_t       page[];
} __rte_packed_end;
...
__rte_packed_begin struct vmbus_gpa {
	uint32_t	len;
	uint32_t	ofs;
	uint64_t	page;
} __rte_packed_end;

__rte_packed_begin struct vmbus_chanpkt_hdr {
...
__rte_packed_begin struct vmbus_chanpkt {
	struct vmbus_chanpkt_hdr hdr;
} __rte_packed_end;

__rte_packed_begin struct vmbus_rxbuf_desc {
	uint32_t	len;
	uint32_t	ofs;
} __rte_packed_end;

__rte_packed_begin struct vmbus_chanpkt_rxbuf {
	struct vmbus_chanpkt_hdr hdr;
	uint16_t	rxbuf_id;
	uint16_t	rsvd;
	uint32_t	rxbuf_cnt;
...
__rte_packed_begin struct vmbus_chanpkt_sglist {
	struct vmbus_chanpkt_hdr hdr;
	uint32_t	rsvd;
	uint32_t	gpa_cnt;
...
__rte_packed_begin struct vmbus_chanmsg_hdr {
	uint32_t	type;	/* VMBUS_CHANMSG_TYPE_ */
	uint32_t	rsvd;
} __rte_packed_end;

/* VMBUS_CHANMSG_TYPE_CONNECT */
__rte_packed_begin struct vmbus_chanmsg_connect {
...
__rte_packed_begin struct vmbus_chanmsg_connect_resp {
	struct vmbus_chanmsg_hdr hdr;
	uint8_t		done;
} __rte_packed_end;

/* VMBUS_CHANMSG_TYPE_CHREQUEST */
__rte_packed_begin struct vmbus_chanmsg_chrequest {
	struct vmbus_chanmsg_hdr hdr;
} __rte_packed_end;

/* VMBUS_CHANMSG_TYPE_DISCONNECT */
__rte_packed_begin struct vmbus_chanmsg_disconnect {
	struct vmbus_chanmsg_hdr hdr;
} __rte_packed_end;

/* VMBUS_CHANMSG_TYPE_CHOPEN */
__rte_packed_begin struct vmbus_chanmsg_chopen {
	struct vmbus_chanmsg_hdr hdr;
	uint32_t	chanid;
	uint32_t	openid;
	uint32_t	gpadl;
...
__rte_packed_begin struct vmbus_chanmsg_chopen_resp {
	struct vmbus_chanmsg_hdr hdr;
	uint32_t	chanid;
	uint32_t	openid;
	uint32_t	status;
...
__rte_packed_begin struct vmbus_chanmsg_gpadl_subconn {
	struct vmbus_chanmsg_hdr hdr;
	uint32_t	msgno;
	uint32_t	gpadl;
	uint64_t	gpa_page[];
...
__rte_packed_begin struct vmbus_chanmsg_chclose {
	struct vmbus_chanmsg_hdr hdr;
	uint32_t	chanid;
} __rte_packed_end;

/* VMBUS_CHANMSG_TYPE_GPADL_DISCONN */
__rte_packed_begin struct vmbus_chanmsg_gpadl_disconn {
	struct vmbus_chanmsg_hdr hdr;
	uint32_t	chanid;
	uint32_t	gpadl;
} __rte_packed_end;
...
__rte_packed_begin struct vmbus_chanmsg_chfree {
	struct vmbus_chanmsg_hdr hdr;
	uint32_t	chanid;
} __rte_packed_end;

/* VMBUS_CHANMSG_TYPE_CHRESCIND */
__rte_packed_begin struct vmbus_chanmsg_chrescind {
	struct vmbus_chanmsg_hdr hdr;
	uint32_t	chanid;
} __rte_packed_end;

/* VMBUS_CHANMSG_TYPE_CHOFFER */
__rte_packed_begin struct vmbus_chanmsg_choffer {
	struct vmbus_chanmsg_hdr hdr;
	rte_uuid_t	chtype;
	rte_uuid_t	chinst;
