				    ...
				    union nbl_chan_info *chan_info)
{
	...
	NBL_UPDATE_QUEUE_TAIL_PTR(chan_info, hw_ops, chan_mgt, rxq->tail_ptr, NBL_MB_RX_QID);
				 ...
				 union nbl_chan_info *chan_info)
{
	...
	NBL_UPDATE_QUEUE_TAIL_PTR(chan_info, hw_ops, chan_mgt, txq->tail_ptr, NBL_MB_TX_QID);
