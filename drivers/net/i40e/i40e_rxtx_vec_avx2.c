			 ...
			 const uint32_t desc_idx)
{
	...
	__m128i *rxdp_desc_0 = (void *)RTE_IGNORE_CAST_QUAL
			((&rxdp[desc_idx + 0].wb.qword2));
	__m128i *rxdp_desc_1 = (void *)RTE_IGNORE_CAST_QUAL
