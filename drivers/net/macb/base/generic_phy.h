...
struct phy_driver {
	...
	void (*read_status)(struct phy_device *phydev);
...
void genphy_resume(struct phy_device *phydev);
void genphy_suspend(struct phy_device *phydev);
int genphy_force_speed_duplex(struct phy_device *phydev);
int genphy_check_for_link(struct phy_device *phydev);
void genphy_read_status(struct phy_device *phydev);

/* for usxgmii interface */
void macb_usxgmii_pcs_resume(struct phy_device *phydev);
