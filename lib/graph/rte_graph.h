...
struct __rte_cache_aligned rte_graph_cluster_node_stats {
	...
	uint8_t error_cntrs;			      /**< Number of Node error counters. */
	char (*error_desc)[RTE_NODE_ERROR_DESC_SIZE]; /**< Names of the Node error counters. */
	uint64_t *error_count;			      /**< Total error count per each error. */
