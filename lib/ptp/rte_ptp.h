 ...
 */
static inline bool
rte_ptp_is_event(uint8_t msg_type)
{
	return msg_type <= RTE_PTP_MSGTYPE_PDELAY_RESP;
}
 ...
 * Supports L2 (EtherType 0x88F7), VLAN-tagged L2, and PTP over
 ...
 * and PTP over UDP/IPv4 encapsulations.
 *
 * @param m
 *   Pointer to the mbuf.
 * @return
