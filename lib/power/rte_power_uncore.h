...
/**
 * Initialize uncore frequency managment for specific die on a package. It will check and set the
...
/**
 * Exit uncore frequency management on a specific die on a package. It will set the governor to which
