 ...
 *
 * @param name
 *   Name of an event listed under /sys/bus/event_source/devices/pmu/events, wher pmu is
 *   a placeholder for an event source.
 * @return
 ...
 *
 * @param pattern
 *   Pattern e=ev1[,ev2,...] matching events, listed under /sys/bus/event_source/devices/pmu/events,
