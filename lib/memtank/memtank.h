...
struct __rte_cache_aligned memchunk {
...
struct __rte_cache_aligned mchunk_list {
	rte_spinlock_t lock;
...
struct __rte_cache_aligned memtank_free {
	rte_spinlock_t lock;
	uint32_t min_free;
	uint32_t max_free;
	uint32_t nb_free;
...
struct rte_memtank {
	...
	uint32_t obj_align;	        /* alignment  of each memobj */
