...
/**
 * @file
 * Internal flow parser API for testpmd and DPDK testing.
 *
 * This header exposes internal functions, structures, and configuration
 * accessors that are not part of the public flow parser API. These are
 * intended for use by testpmd and DPDK test applications only.
 *
